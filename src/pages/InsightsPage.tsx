            ...
            <Modal open={softwallOpen} onClose={() => setSoftwallOpen(false)}>
                <div className={css({ display: "flex", flexDirection: "column", gap: "3" })}>
                    ...
                    <p className={css({ fontSize: "sm", color: "gray.700" })}>
                        Create a free account to unlock 7-day, 30-day and lifetime history across devices.
                    </p>
                    <div className={css({ display: "flex", gap: "2", justifyContent: "flex-end" })}>
                        <button
                            type="button"
                            className={css({ paddingX: "3", paddingY: "2", borderRadius: "sm", backgroundColor: "gray.100" })}
                        ...
                        <button
                            type="button"
                            className={css({ paddingX: "3", paddingY: "2", borderRadius: "sm", backgroundColor: "green.600", color: "white" })}
